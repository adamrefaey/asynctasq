...
class TestDriverFactoryCreateFromConfig:
    ...
    @patch("q_task.drivers.redis_driver.RedisDriver")
    ...
    @patch("q_task.drivers.sqs_driver.SQSDriver")
    ...
    @patch("q_task.drivers.postgres_driver.PostgresDriver")
    ...
    @patch("q_task.drivers.mysql_driver.MySQLDriver")

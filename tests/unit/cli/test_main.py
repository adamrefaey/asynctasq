...
from q_task.cli.commands.migrate import MigrationError
from q_task.cli.main import main as cli_main
from q_task.cli.main import run_command
...
class TestRunCommand:
    ...
    @patch("q_task.cli.main.build_config")
    @patch("q_task.cli.main.asyncio.run")
    @patch("q_task.cli.main.run_worker")
    ...
    @patch("q_task.cli.main.build_config")
    @patch("q_task.cli.main.asyncio.run")
    @patch("q_task.cli.main.run_migrate")
...
class TestMain:
    ...
    @patch("q_task.cli.main.setup_logging")
    @patch("q_task.cli.main.create_parser")
    @patch("q_task.cli.main.run_command")

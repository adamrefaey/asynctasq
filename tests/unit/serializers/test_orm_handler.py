...
from asynctasq.serializers.orm_handler import OrmHandler
...
class TestOrmHandlerModelDetection:
    ...
    @patch("asynctasq.serializers.orm_handler.SQLALCHEMY_AVAILABLE", True)
    @patch("asynctasq.serializers.orm_handler.DeclarativeBase", MagicMock)
    ...
    def test_is_sqlalchemy_model_with_base_class(self, handler):
        ...
        with patch("asynctasq.serializers.orm_handler.DeclarativeBase", mock_base):
    ...
    @patch("asynctasq.serializers.orm_handler.SQLALCHEMY_AVAILABLE", False)
    ...
    @patch("asynctasq.serializers.orm_handler.DJANGO_AVAILABLE", True)
    def test_is_django_model(self, handler):
        ...
        with patch("asynctasq.serializers.orm_handler.django", mock_django):
            # Make obj an instance of the Model class
            obj.__class__ = MockDjangoModelClass
            assert handler._is_django_model(obj) is True

    @patch("asynctasq.serializers.orm_handler.DJANGO_AVAILABLE", False)
    ...
    @patch("asynctasq.serializers.orm_handler.DJANGO_AVAILABLE", True)
    @patch("asynctasq.serializers.orm_handler.django", None)
    ...
    @patch("asynctasq.serializers.orm_handler.TORTOISE_AVAILABLE", True)
    def test_is_tortoise_model(self, handler):
        ...
        with patch("asynctasq.serializers.orm_handler.TortoiseModel", MockTortoiseModelClass):
            # Make obj an instance of the Model class
            obj.__class__ = MockTortoiseModelClass
            assert handler._is_tortoise_model(obj) is True

    @patch("asynctasq.serializers.orm_handler.TORTOISE_AVAILABLE", False)
    ...
    @patch("asynctasq.serializers.orm_handler.TORTOISE_AVAILABLE", True)
    @patch("asynctasq.serializers.orm_handler.TortoiseModel", None)
    ...
    def test_is_tortoise_model_exception_handling(self, handler):
        ...
        with patch("asynctasq.serializers.orm_handler.TortoiseModel", mock_tortoise):
            with patch("builtins.isinstance", side_effect=Exception()):
                assert handler._is_tortoise_model(obj) is False
...
class TestOrmHandlerGetOrmType:
    ...
    @patch("asynctasq.serializers.orm_handler.OrmHandler._is_sqlalchemy_model")
    ...
    @patch("asynctasq.serializers.orm_handler.OrmHandler._is_django_model")
    ...
    @patch("asynctasq.serializers.orm_handler.OrmHandler._is_tortoise_model")
...
class TestOrmHandlerGetModelPk:
    ...
    @patch("asynctasq.serializers.orm_handler.SQLALCHEMY_AVAILABLE", True)
    @patch("asynctasq.serializers.orm_handler.OrmHandler._get_orm_type")
    ...
    def test_get_model_pk_sqlalchemy_not_available(self, mock_get_type, handler):
        ...
        with patch("asynctasq.serializers.orm_handler.SQLALCHEMY_AVAILABLE", False):
...
class TestOrmHandlerSerializeModel:
    ...
    @patch("asynctasq.serializers.orm_handler.OrmHandler._get_orm_type")
    @patch("asynctasq.serializers.orm_handler.OrmHandler._get_model_pk")
    @patch("asynctasq.serializers.orm_handler.OrmHandler._get_model_class_path")
